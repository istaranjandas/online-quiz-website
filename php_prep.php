...
<h1 style="color:white; font-size:3rem; padding:2rem;">PHP PREP</h1>
...
<?php
    if(isset($_POST['submit1'])){
        if(isset($_POST['radio1'])) { $userselected = $_POST['radio1'];
            ...
            $fetchqry2 = "UPDATE php SET userans='$userselected' WHERE id='1'"; 
...
<?php
    if(isset($_POST['submit2'])){
        if(isset($_POST['radio2'])) { $userselected = $_POST['radio2'];
            ...
            $fetchqry2 = "UPDATE php SET userans='$userselected' WHERE id='2'"; 
            $result2 = mysqli_query($con,$fetchqry2); ?> <br> <?php
            echo $row['ans']; 
    }
}
...
<?php
    if(isset($_POST['submit3'])){
        if(isset($_POST['radio3'])) { $userselected = $_POST['radio3'];
            ...
            $fetchqry2 = "UPDATE php SET userans='$userselected' WHERE id='3'"; 
            $result2 = mysqli_query($con,$fetchqry2); ?> <br> <?php
            echo $row['ans']; 
    }
}
...
<?php
    if(isset($_POST['submit4'])){
        if(isset($_POST['radio4'])) { $userselected = $_POST['radio4'];
            ...
            $fetchqry2 = "UPDATE php SET userans='$userselected' WHERE id='4'"; 
            $result2 = mysqli_query($con,$fetchqry2);?> <br> <?php
            echo $row['ans']; 
    }
}
...
<?php
    if(isset($_POST['submit5'])){
        if(isset($_POST['radio5'])) { $userselected = $_POST['radio5'];
            ...
            $fetchqry2 = "UPDATE php SET userans='$userselected' WHERE id='5'"; 
            $result2 = mysqli_query($con,$fetchqry2);?> <br> <?php
            echo $row['ans']; 
    }
}
