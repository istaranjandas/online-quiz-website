...
<?php
    ...
    {
        $fetchqry2 = "UPDATE python SET userans='$userselected1' WHERE id='1'"; 
        $result2 = mysqli_query($con,$fetchqry2);
        $fetchqry2 = "UPDATE python SET userans='$userselected2' WHERE id='2'"; 
        $result2 = mysqli_query($con,$fetchqry2);
        $fetchqry2 = "UPDATE python SET userans='$userselected3' WHERE id='3'"; 
        $result2 = mysqli_query($con,$fetchqry2);
        $fetchqry2 = "UPDATE python SET userans='$userselected4' WHERE id='4'"; 
        $result2 = mysqli_query($con,$fetchqry2);
