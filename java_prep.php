...
$row = mysqli_fetch_array($result,MYSQLI_ASSOC);?>
        <div style="background-color: white; padding:2rem;" class="jumbotron jumbotron-fluid">
            ...
            <input class="btn btn-primary" type="submit" name="submit1" value="Show Answers">
    ...
    if(isset($_POST['submit1'])){
        if(isset($_POST['radio1'])) { $userselected = $_POST['radio1'];
            ...
            $fetchqry2 = "UPDATE java SET userans='$userselected' WHERE id='1'"; 
            $result2 = mysqli_query($con,$fetchqry2); ?> <br> <?php
            ?> <h3> <?php echo $row['ans']; ?></h3> <?php
    }
}
?>
    </div>
...
$row = mysqli_fetch_array($result,MYSQLI_ASSOC);?>
        <div style="background-color: white; padding:2rem;" class="jumbotron jumbotron-fluid">
            ...
            <input class="btn btn-primary" type="submit" name="submit2" value="Show Answers">
    ...
    if(isset($_POST['submit2'])){
        if(isset($_POST['radio2'])) { $userselected = $_POST['radio2'];
            ...
            $fetchqry2 = "UPDATE java SET userans='$userselected' WHERE id='2'"; 
            $result2 = mysqli_query($con,$fetchqry2); ?> <br> <?php
            ?> <h3> <?php echo $row['ans']; ?></h3> <?php
    }
}
...
$row = mysqli_fetch_array($result,MYSQLI_ASSOC);?>
        <div style="background-color: white; padding:2rem;" class="jumbotron jumbotron-fluid">
            ...
            <input class="btn btn-primary" type="submit" name="submit3" value="Show Answers">
    ...
    if(isset($_POST['submit3'])){
        if(isset($_POST['radio3'])) { $userselected = $_POST['radio3'];
            ...
            $fetchqry2 = "UPDATE java SET userans='$userselected' WHERE id='3'"; 
            $result2 = mysqli_query($con,$fetchqry2); ?> <br> <?php
            ?> <h3> <?php echo $row['ans']; ?></h3> <?php 
    }
}
...
$row = mysqli_fetch_array($result,MYSQLI_ASSOC);?>
        <div style="background-color: white; padding:2rem;" class="jumbotron jumbotron-fluid">
            ...
            <input class="btn btn-primary" type="submit" name="submit4" value="Show Answers">
    ...
    if(isset($_POST['submit4'])){
        if(isset($_POST['radio4'])) { $userselected = $_POST['radio4'];
            ...
            $fetchqry2 = "UPDATE java SET userans='$userselected' WHERE id='4'"; 
            $result2 = mysqli_query($con,$fetchqry2);?> <br> <?php
              ?> <h3> <?php echo $row['ans']; ?></h3> <?php
    }
}
...
$row = mysqli_fetch_array($result,MYSQLI_ASSOC);?>
        <div style="background-color: white; padding:2rem;" class="jumbotron jumbotron-fluid">
            ...
            <input class="btn btn-primary" type="submit" name="submit5" value="Show Answers">
    ...
    if(isset($_POST['submit5'])){
        if(isset($_POST['radio5'])) { $userselected = $_POST['radio5'];
            ...
            $fetchqry2 = "UPDATE java SET userans='$userselected' WHERE id='5'"; 
            $result2 = mysqli_query($con,$fetchqry2); ?> <br> <?php
            ?> <h3> <?php echo $row['ans']; ?></h3> <?php 
    }
}
