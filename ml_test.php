...
<h1 style="color:white; font-size:3rem; padding:2rem;">ML Quiz</h1>
<?php 
...
<?php
    ...
    {
        $fetchqry2 = "UPDATE ml SET userans='$userselected1' WHERE id='1'"; 
        $result2 = mysqli_query($con,$fetchqry2);
        $fetchqry2 = "UPDATE ml SET userans='$userselected2' WHERE id='2'"; 
        $result2 = mysqli_query($con,$fetchqry2);
        $fetchqry2 = "UPDATE ml SET userans='$userselected3' WHERE id='3'"; 
        $result2 = mysqli_query($con,$fetchqry2);
        $fetchqry2 = "UPDATE ml SET userans='$userselected4' WHERE id='4'"; 
        $result2 = mysqli_query($con,$fetchqry2);
        $fetchqry2 = "UPDATE ml SET userans='$userselected5' WHERE id='5'"; 
        $result2 = mysqli_query($con,$fetchqry2);
        header("Location: score_card5.php");
    }
